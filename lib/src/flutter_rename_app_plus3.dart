library flutter_rename_app_plus3;

import 'dart:io';

import 'package:flutter_rename_app_plus3/src/changes/files_to_modify_name.dart';
import 'package:flutter_rename_app_plus3/src/utils/logger.dart';
...
renameApp() async {
  try {
    ...
    //Logger.info(contentChanges.map((e) => e.toJson()).toList().toString());
